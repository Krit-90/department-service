...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    @Query(value = "Select b From Employee b Where b.isBoss = true and b.department.id = :departmentId")
    Employee getBossOfDepartment(@Param("departmentId") Long id);

    @Query(value = "Select count(b.id) From Employee b Where b.isBoss = true and b.department.id = :departmentId")
